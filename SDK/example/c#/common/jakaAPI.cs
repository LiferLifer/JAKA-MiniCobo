...
namespace jakaApi
{
	...
	public class jakaAPI
	{
		...
		public static extern int circular_move_extend(ref int i, ref JKTYPE.CartesianPose end_pos, ref JKTYPE.CartesianPose mid_pos, JKTYPE.MoveMode move_mode, bool is_block, double speed, double acc, double tol, ref JKTYPE.OptionalCond option_cond, int circle_cnt);
		...
		public static extern int set_admit_ctrl_config(ref int i, int axis, int opt, double ftUser, double ftConstant, int ftNnormalTrack, double ftReboundFK);
		...
		public static extern int set_torque_sensor_soft_limit(ref int i, JKTYPE.FTxyz torque_sensor_soft_limit);
		...
		public static extern int get_torque_sensor_soft_limit(ref int i, ref JKTYPE.FTxyz torque_sensor_soft_limit);
		...
		public static extern int set_block_wait_timeout(ref int i, float seconds);
		...
		public static extern int get_rs485_signal_info(ref int i, ref JKTYPE.SignInfo sign_info);
